 ...
 */
public class TFScoreScript extends AbstractSearchScript {
    ...
    private HashSet<String> tokens = null;
    private Integer mingram = null;
    private Integer maxgram = null;
    private Boolean lowercase = null;
    private Boolean foldascii = null;
    ...
    public static class Factory implements NativeScriptFactory {
        ...
        public ExecutableScript newScript(@Nullable Map<String, Object> params) {
            return new TFScoreScript(params);
        }
    }
    ...
    private TFScoreScript(Map<String, Object> params) {
        ...
        lowercase = params.containsKey("lowercase") ? (Boolean) params.get("lowercase") : false;
        foldascii = params.containsKey("foldascii") ? (Boolean) params.get("foldascii") : false;
    ...
    private HashSet<String> tokenize(String querystring) {
        ...
        int n = mingram;
        while (n <= maxgram) {
            if (querystring.length() <= n) {
                allTokens.add(normalizeString(querystring));
            }
            else {
                int i = 0;
                while (i <= querystring.length() - n) {
                    allTokens.add(normalizeString(querystring.substring(i, i + n)));
                    i++;
                }
            }
            n++;
    ...
    private String normalizeString(String querystring) {
        String normString = querystring;
        if (foldascii) {
            normString = foldToASCII(normString);
        }
        if (lowercase) {
    ...
    // This is character replacement function from org.apache.lucene.analysis.miscellaneous.ASCIIFoldingFilter
    private String foldToASCII(String queryString)
    {
        char[] input = queryString.toCharArray();
